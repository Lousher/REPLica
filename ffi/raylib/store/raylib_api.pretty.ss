((defines
   ...
   ((name . "KeyboardKey")
     ...
     (values
      ...
      ((name . "KEY_APOSTROPHE")
        (value . 39)
        (description . "Key: '"))
      ((name . "KEY_COMMA") (value . 44) (description . "Key: ,"))
      ((name . "KEY_MINUS") (value . 45) (description . "Key: -"))
      ((name . "KEY_PERIOD")
        (value . 46)
        (description . "Key: ."))
      ((name . "KEY_SLASH") (value . 47) (description . "Key: /"))
      ((name . "KEY_ZERO") (value . 48) (description . "Key: 0"))
      ((name . "KEY_ONE") (value . 49) (description . "Key: 1"))
      ((name . "KEY_TWO") (value . 50) (description . "Key: 2"))
      ((name . "KEY_THREE") (value . 51) (description . "Key: 3"))
      ((name . "KEY_FOUR") (value . 52) (description . "Key: 4"))
      ((name . "KEY_FIVE") (value . 53) (description . "Key: 5"))
      ((name . "KEY_SIX") (value . 54) (description . "Key: 6"))
      ((name . "KEY_SEVEN") (value . 55) (description . "Key: 7"))
      ((name . "KEY_EIGHT") (value . 56) (description . "Key: 8"))
      ((name . "KEY_NINE") (value . 57) (description . "Key: 9"))
      ((name . "KEY_SEMICOLON")
        (value . 59)
        (description . "Key: ;"))
      ((name . "KEY_EQUAL") (value . 61) (description . "Key: ="))
      ((name . "KEY_A") (value . 65) (description . "Key: A | a"))
      ((name . "KEY_B") (value . 66) (description . "Key: B | b"))
      ((name . "KEY_C") (value . 67) (description . "Key: C | c"))
      ((name . "KEY_D") (value . 68) (description . "Key: D | d"))
      ((name . "KEY_E") (value . 69) (description . "Key: E | e"))
      ((name . "KEY_F") (value . 70) (description . "Key: F | f"))
      ((name . "KEY_G") (value . 71) (description . "Key: G | g"))
      ((name . "KEY_H") (value . 72) (description . "Key: H | h"))
      ((name . "KEY_I") (value . 73) (description . "Key: I | i"))
      ((name . "KEY_J") (value . 74) (description . "Key: J | j"))
      ((name . "KEY_K") (value . 75) (description . "Key: K | k"))
      ((name . "KEY_L") (value . 76) (description . "Key: L | l"))
      ((name . "KEY_M") (value . 77) (description . "Key: M | m"))
      ((name . "KEY_N") (value . 78) (description . "Key: N | n"))
      ((name . "KEY_O") (value . 79) (description . "Key: O | o"))
      ((name . "KEY_P") (value . 80) (description . "Key: P | p"))
      ((name . "KEY_Q") (value . 81) (description . "Key: Q | q"))
      ((name . "KEY_R") (value . 82) (description . "Key: R | r"))
      ((name . "KEY_S") (value . 83) (description . "Key: S | s"))
      ((name . "KEY_T") (value . 84) (description . "Key: T | t"))
      ((name . "KEY_U") (value . 85) (description . "Key: U | u"))
      ((name . "KEY_V") (value . 86) (description . "Key: V | v"))
      ((name . "KEY_W") (value . 87) (description . "Key: W | w"))
      ((name . "KEY_X") (value . 88) (description . "Key: X | x"))
      ((name . "KEY_Y") (value . 89) (description . "Key: Y | y"))
      ((name . "KEY_Z") (value . 90) (description . "Key: Z | z"))
      ...
      ((name . "KEY_RIGHT_BRACKET")
        (value . 93)
        (description . "Key: ]"))
      ((name . "KEY_GRAVE") (value . 96) (description . "Key: `"))
      ((name . "KEY_SPACE")
        (value . 32)
      ...
      ((name . "KEY_F1") (value . 290) (description . "Key: F1"))
      ((name . "KEY_F2") (value . 291) (description . "Key: F2"))
      ((name . "KEY_F3") (value . 292) (description . "Key: F3"))
      ((name . "KEY_F4") (value . 293) (description . "Key: F4"))
      ((name . "KEY_F5") (value . 294) (description . "Key: F5"))
      ((name . "KEY_F6") (value . 295) (description . "Key: F6"))
      ((name . "KEY_F7") (value . 296) (description . "Key: F7"))
      ((name . "KEY_F8") (value . 297) (description . "Key: F8"))
      ((name . "KEY_F9") (value . 298) (description . "Key: F9"))
      ((name . "KEY_F10")
        (value . 299)
        (description . "Key: F10"))
      ((name . "KEY_F11")
  ...
  (functions
   ...
   ((name . "IsWindowState")
     ...
     (returnType . "bool")
     (params ((type . "unsigned int") (name . "flag"))))
   ((name . "SetWindowState")
   ...
   ((name . "SetWindowTitle")
     ...
     (returnType . "void")
     (params ((type . "const char *") (name . "title"))))
   ...
   ((name . "SetWindowOpacity")
     ...
     (returnType . "void")
     (params ((type . "float") (name . "opacity"))))
   ...
   ((name . "SetClipboardText")
     ...
     (returnType . "void")
     (params ((type . "const char *") (name . "text"))))
   ...
   ((name . "WaitTime")
     ...
     (returnType . "void")
     (params ((type . "double") (name . "seconds"))))
   ((name . "SetRandomSeed")
     (description
       .
       "Set the seed for the random number generator")
     (returnType . "void")
     (params ((type . "unsigned int") (name . "seed"))))
   ((name . "GetRandomValue")
     (description
       .
   ...
   ((name . "OpenURL")
     ...
     (returnType . "void")
     (params ((type . "const char *") (name . "url"))))
   ((name . "SetTraceLogLevel")
     (description
       .
       "Set the current threshold (minimum) log level")
     (returnType . "void")
     (params ((type . "int") (name . "logLevel"))))
   ((name . "TraceLog")
     (description
       .
   ...
   ((name . "MemAlloc")
     ...
     (returnType . "void *")
     (params ((type . "unsigned int") (name . "size"))))
   ((name . "MemRealloc")
   ...
   ((name . "UnloadFileData")
     ...
     (returnType . "void")
     (params ((type . "unsigned char *") (name . "data"))))
   ((name . "SaveFileData")
     (description
       .
   ...
   ((name . "GetFileName")
     ...
     (returnType . "const char *")
     (params ((type . "const char *") (name . "filePath"))))
   ...
   ((name . "SetGamepadMappings")
     ...
     (returnType . "int")
     (params ((type . "const char *") (name . "mappings"))))
   ...
   ((name . "IsGestureDetected")
     ...
     (returnType . "bool")
     (params ((type . "unsigned int") (name . "gesture"))))
   ...
   ((name . "DrawLine")
     ...
     (returnType . "void")
     (params ((type . "int") (name . "startPosX"))
   ...
   ((name . "DrawLineDashed")
     ...
     (returnType . "void")
     (params ((type . "Vector2") (name . "startPos"))
       ((type . "Vector2") (name . "endPos"))
   ...
   ((name . "DrawCircleSector")
     ...
     (returnType . "void")
     (params ((type . "Vector2") (name . "center"))
       ((type . "float") (name . "radius"))
   ...
   ((name . "DrawRectangleGradientEx")
     ...
     (returnType . "void")
     (params ((type . "Rectangle") (name . "rec"))
   ...
   ((name . "CheckCollisionLines")
     ...
     (returnType . "bool")
     (params ((type . "Vector2") (name . "startPos1"))
   ...
   ((name . "LoadFontFromMemory")
     ...
     (returnType . "Font")
     (params ((type . "const char *") (name . "fileType"))
       ((type . "const unsigned char *") (name . "fileData"))
       ((type . "int") (name . "dataSize"))
       ((type . "int") (name . "fontSize"))
       ((type . "const int *") (name . "codepoints"))
   ...
   ((name . "LoadFontData")
     ...
     (params ((type . "const unsigned char *") (name . "fileData"))
       ((type . "int") (name . "dataSize"))
       ((type . "int") (name . "fontSize"))
       ((type . "const int *") (name . "codepoints"))
       ((type . "int") (name . "codepointCount"))
   ...
   ((name . "GenImageFontAtlas")
     ...
     (returnType . "Image")
     (params ((type . "const GlyphInfo *") (name . "glyphs"))
   ...
   ((name . "UnloadCodepoints")
     ...
     (returnType . "void")
     (params ((type . "int *") (name . "codepoints"))))
   ...
   ((name . "DrawCircle3D")
     ...
     (returnType . "void")
     (params ((type . "Vector3") (name . "center"))
       ((type . "float") (name . "radius"))
   ...
   ((name . "DrawCube")
     ...
     (returnType . "void")
     (params ((type . "Vector3") (name . "position"))
   ...
   ((name . "DrawSphereEx")
     ...
     (returnType . "void")
     (params ((type . "Vector3") (name . "centerPos"))
       ((type . "float") (name . "radius"))
       ((type . "int") (name . "rings"))
   ...
   ((name . "DrawCylinderEx")
     ...
     (returnType . "void")
     (params ((type . "Vector3") (name . "startPos"))
       ((type . "Vector3") (name . "endPos"))
   ...
   ((name . "UnloadWaveSamples")
     ...
     (returnType . "void")
     (params ((type . "float *") (name . "samples"))))
   ...
   ((name . "AttachAudioMixedProcessor")
     ...
     (returnType . "void")
     (params ((type . "AudioCallback") (name . "processor"))))
