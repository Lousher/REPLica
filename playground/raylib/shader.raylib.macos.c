...
int main(void)
{
    ...
    Texture texRed = LoadTexture("../../assets/bg/a.jpg");

    Texture texBlue = LoadTexture("../../assets/bg/b.jpg");

    Shader shader = LoadShader(0, TextFormat("./wipe.right.fs", GLSL_VERSION));
    ...
    while (!WindowShouldClose())                // Detect window close button or ESC key
    {
      ...
      if (isActive)
        ...
        if (IsKeyDown(KEY_SPACE)) isActive = true;
